	...
	function tabs:CreateTab(name)
		...
		function mytabbuttons:CreateFrame(name)
			...
			function pagebuttons:CreateBox(name, icon, callback)
				...
				TextInput.PlaceholderColor3 = Color3.fromRGB(227, 225, 228)
				TextInput.PlaceholderText = name --"Input Text Here..."
				TextInput.Text = ""
				TextInput.TextColor3 = Color3.fromRGB(227, 225, 228)
			...
			function pagebuttons:CreateBind(name, defaultkey, callback)
				...
				KButton.MouseButton1Click:Connect(function()
					if keybindtoggle == false then
						keybindtoggle = true
						KButton.Text = ". . ."
						Thing = game:GetService("UserInputService").InputBegan:wait()
						if inputwait.KeyCode.Name ~= "Unknown" then
							KButton.Text = inputwait.KeyCode.Name
			...
			function pagebuttons:CreateColorPicker(name, callback)
				...
				UICorner_3.CornerRadius = UDim.new(0, 5, 0, 9)
				...
				mouse.Move:Connect(function()
					...
					if movingDarknessSlider then
						...
						xOffset = math.clamp(xOffset, 0, darknessGradientFrame.AbsoluteSize.X)
