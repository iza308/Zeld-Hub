...
local ConfigUpdates = {}
local Themes = {
    ['Default'] = { -- Modified Default Theme for Cleaner Dark Look
        BackgroundColor = Color3.fromRGB(35, 35, 35), -- Slightly lighter background
        SidebarColor = Color3.fromRGB(40, 40, 40), -- Slightly lighter sidebar
        PrimaryTextColor = Color3.fromRGB(255, 255, 255),
        SecondaryTextColor = Color3.fromRGB(150, 150, 150), -- Lighter secondary text
        UIStrokeColor = Color3.fromRGB(70, 70, 70), -- Lighter strokes
        PrimaryElementColor = Color3.fromRGB(40, 40, 40), -- Lighter primary elements
        SecondaryElementColor = Color3.fromRGB(60, 60, 60), -- Lighter secondary elements
        OtherElementColor = Color3.fromRGB(35, 35, 35), -- Lighter other elements
        ScrollBarColor = Color3.fromRGB(150, 150, 150), -- Lighter scrollbar
        PromptColor = Color3.fromRGB(50, 50, 50), -- Lighter prompt
        NotificationColor = Color3.fromRGB(35, 35, 35), -- Lighter notification
        NotificationUIStrokeColor = Color3.fromRGB(150, 150, 150) -- Lighter notification stroke
    },
    ['GoodUI'] = { -- New "GoodUI" Theme - Light and Clean
        BackgroundColor = Color3.fromRGB(245, 245, 245), -- Light grey background
        SidebarColor = Color3.fromRGB(255, 255, 255), -- White sidebar
        PrimaryTextColor = Color3.fromRGB(0, 0, 0),
        SecondaryTextColor = Color3.fromRGB(100, 100, 100), -- Medium grey secondary text
        UIStrokeColor = Color3.fromRGB(200, 200, 200), -- Light grey strokes
        PrimaryElementColor = Color3.fromRGB(255, 255, 255), -- White primary elements
        SecondaryElementColor = Color3.fromRGB(230, 230, 230), -- Light grey secondary elements
        OtherElementColor = Color3.fromRGB(245, 245, 245), -- Light grey other elements
        ScrollBarColor = Color3.fromRGB(180, 180, 180), -- Light grey scrollbar
        PromptColor = Color3.fromRGB(250, 250, 250), -- Very light grey prompt
        NotificationColor = Color3.fromRGB(245, 245, 245), -- Light grey notification
        NotificationUIStrokeColor = Color3.fromRGB(200, 200, 200) -- Light grey notification stroke
    },
    ['Lighter'] = {
...
do
            ...
            if not CoreGui:FindFirstChild('Visual UI Library | .gg/puxxCphTnK | Notifications') then
                ...
                Utility:Create('Frame', {
                    ...
                    Utility:Create('TextLabel', {
                        ...
                        Font = Enum.Font.Minecraftia, -- Minecraftia Font!
                        Text = Title,
                ...
                local TextSize = TextService:GetTextSize(Text, 14, Enum.Font.Minecraftia, Vector2.new(300, math.huge)) -- Minecraftia Font!
    ...
    function Library:CreatePrompt(Type, Title, Text, ...)
        ...
        if Type == 'Text' then
            ...
            local TitleTextSize = TextService:GetTextSize(Title, 20, Enum.Font.Minecraftia, Vector2.new(280, 0)) -- Minecraftia Font!
        ...
        elseif Type == 'OneButton' then
            ...
            Utility:Tween(PromptHolder, { BackgroundTransparency = 0.1 }, 0.25)
            task.wait(0.25)
            Utility:Tween(PromptFrame, { BackgroundTransparency = NotificationTransparency0 }, 0.25) -- Typo here, should be NotificationTransparency
            Utility:Tween(PromptFrame, { Size = UDim2.new(0, 300, 0, 150) }, 0.25)
            Utility:Tween(PromptFrameCorner, { CornerRadius = UDim.new(0, 5) }, 0.25)
            task.wait(0.25)
            Utility:Tween(ButtonStroke, { Thickness = 1 }, 0.25)
...
function Library:CreateWindow(HubName, GameName, IntroText, IntroIcon, ImprovePerformance, ConfigFolder, Theme)
    ...
    elseif type(Theme) == 'string' then
        ...
        if Theme == 'default' then
            Theme = Themes['Default']
        elseif Theme == 'goodui' then -- New Theme Option
            Theme = Themes['GoodUI']
    ...
    local HubNameTextSize = TextService:GetTextSize(HubNameObj.Text, 18, Enum.Font.Minecraftia, Vector2.new(410, math.huge)) -- Minecraftia Font!
    local GameNameTextSize = TextService:GetTextSize(GameNameObj.Text, 16, Enum.Font.Minecraftia, Vector2.new(410, math.huge)) -- Minecraftia Font!
    ...
    if HubNameTextSize.X >= 165 then
        ...
        repeat
            ...
            local HubNameTextSize = TextService:GetTextSize(NewText, 18, Enum.Font.Minecraftia, Vector2.new(410, math.huge)) -- Minecraftia Font!
            X = HubNameTextSize.X
        until X < 165
        for _ = 1, 2 do
            NewText = NewText:sub(0, -2)
    ...
    if GameNameTextSize.X >= 175 then
        ...
        repeat
            NewText = NewText:sub(0, -2)
            local GameNameTextSize = TextService:GetTextSize(NewText, 18, Enum.Font.Minecraftia, Vector2.new(410, math.huge)) -- Minecraftia Font!
    ...
    function Library:ChangeTheme(NewTheme)
        if not ImprovePerformance then
            ...
            elseif type(NewTheme) == 'string' then
                ...
                if NewTheme == NewTheme = NewTheme:lower()
                    ...
                    elseif NewTheme == 'default' then
                        ...
                        Config['Theme_4z3s4QrUhfqt703FmiAe'] = HttpService:JSONEncode(NewTable)
                        ChangeThemeValue()
                    elseif NewTheme == 'goodui' then -- GoodUI Theme Option
                        Theme = Themes['GoodUI']
                        local NewTable = {}
                        for Index, Value in next, Theme do
                            NewTable[Index] = Utility:SplitColor(Value)
    ...
    function Tabs:CreateTab(TabName, DefaultVisibility, Icon, RectOffset, RectSize)
        ...
        function Sections:CreateSection(Name)
            ...
            function Elements:CreateParagraph(Title, Paragraph)
                ...
                local TextSizeOld = TextService:GetTextSize(Paragraph, 14, Enum.Font.Minecraftia, Vector2.new(410, math.huge)) -- Minecraftia Font!
                ...
                function ParagraphFunctions:UpdateParagraph(NewTitle, NewParagraph)
                    ...
                    local TextSizeNew = TextService:GetTextSize(ParagraphContent.Text, 14, Enum.Font.Minecraftia, Vector2.new(410, math.huge)) -- Minecraftia Font!
                    local TextSizeOld = TextService:GetTextSize(Old, 14, Enum.Font.Minecraftia, Vector2.new(410, math.huge)) -- Minecraftia Font!
            ...
            function Elements:CreateSlider(Name, MinimumValue, MaximumValue, DefaultValue, SliderColor, Callback)
                -- ... (Rest of the Elements:CreateSlider function - no changes needed for font here) ...
            ...
            function Elements:CreateTextbox(Name, Placeholder, Callback)
                -- ... (Rest of the Elements:CreateTextbox function - only font change needed) ...
                ...
                local TextSize = TextService:GetTextSize(Placeholder, 14, Enum.Font.Minecraftia, Vector2.new(410, 40)) -- Minecraftia Font!
                ...
                Textbox.Changed:Connect(function(Property)
                    if Property == 'Text' then
                        ...
                        local TextSize = TextService:GetTextSize(Textbox.Text, 14, Enum.Font.Minecraftia, Vector2.new(410, 40)) -- Minecraftia Font!
            ...
            function Elements:CreateKeybind(Name, Key, Callback)
                -- ... (Rest of the Elements:CreateKeybind function - only font change needed) ...
                ...
                TextSize = TextService:GetTextSize(Current, 14, Enum.Font.Minecraftia, Vector2.new(410, 40)) -- Minecraftia Font!
                ...
                Keybind.MouseButton1Click:Connect(function()
                    ...
                    if Input.KeyCode.Name ~= 'Unknown' then
                        ...
                        TextSize = TextService:GetTextSize(Input.KeyCode.Name, 14, Enum.Font.Minecraftia, Vector2.new(410, 40)) -- Minecraftia Font!
                        if TextSize.X < 25 then
                            Utility:Tween(Keybind, {Size = UDim2.new(0, 25, 0, 25)}, 0.25)
                        else
                            Utility:Tween(Keybind, {Size = UDim2.new(0, TextSize.X + 10, 0, 25)}, 0.25)
            ...
            function Elements:CreateToggle(Name, Default, ToggleColor, DebounceAmount, Callback)
                -- ... (Rest of the Elements:CreateToggle function - no font changes needed) ...
            ...
            function Elements:CreateDropdown(Name, List, Default, DebounceAmount, Callback)
                 -- ... (Rest of the Elements:CreateDropdown function - only font change needed) ...
            ...
            function Elements:CreateColorpicker(Name, DefaultColor, DebounceAmount, Callback, ...)
                -- ... (Rest of the Elements:CreateColorpicker function - no font changes needed) ...
            ...
            function Elements:CreateImage(Name, URL, ImageSize)
                -- ... (Rest of the Elements:CreateImage function - no font changes needed) ...
